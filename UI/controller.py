...
class Controller:
    ...
    def mostra_automobili(self):
        ...
        self._view.lista_auto.clean() #pulisca la List View
        if lista_automobili is None:
            ...
            for auto in lista_automobili:
                ...
                self._view.lista_auto.append(ft.Text(str(auto))) #Aggiungo le auto dentro la list view
    ...
    def cerca_automobili_per_modello(self, input_modello_auto):
        ...
        self._view.lista_auto_ricerca.clean()
